...
namespace NppPluginNET
{
    ...
    {
        #region " Fields "
        internal const string PluginName = "Chrome Search Markers";
        ...
        static frmMarkerPanel frmGoToLine = null;
        ...
        static internal void CommandMenuInit()
        {
            ...
            //            );
            SetCommand(0, "Toggle Chrome Markers", DockableMarkerForm, new ShortcutKey(false, true, false, Keys.F));
            //This must be set to the last menu command index
            idFrmGotToLine = 0;
        }
        ...
        static void DockableMarkerForm()
        {
            ...
            if (frmGoToLine == null)
            {
                frmGoToLine = new frmMarkerPanel();
